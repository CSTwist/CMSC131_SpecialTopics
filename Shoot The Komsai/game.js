...
var ASM_CONSTS = {
  65540: () => { return window.innerWidth; }
};

// Imports from the Wasm binary.
var _update = Module['_update'] = makeInvalidEarlyAccess('_update');
var _get_x = Module['_get_x'] = makeInvalidEarlyAccess('_get_x');
var _right_movement = Module['_right_movement'] = makeInvalidEarlyAccess('_right_movement');
var _left_movement = Module['_left_movement'] = makeInvalidEarlyAccess('_left_movement');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['update'] != 'undefined', 'missing Wasm export: update');
  _update = Module['_update'] = createExportWrapper('update', 0);
  assert(typeof wasmExports['get_x'] != 'undefined', 'missing Wasm export: get_x');
  _get_x = Module['_get_x'] = createExportWrapper('get_x', 0);
  assert(typeof wasmExports['right_movement'] != 'undefined', 'missing Wasm export: right_movement');
  _right_movement = Module['_right_movement'] = createExportWrapper('right_movement', 0);
  assert(typeof wasmExports['left_movement'] != 'undefined', 'missing Wasm export: left_movement');
  _left_movement = Module['_left_movement'] = createExportWrapper('left_movement', 0);
